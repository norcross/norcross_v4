...
class NorcrossVersionFour {
    ...
    // CSS first
    wp_enqueue_style( 'foundation', RKV_BASE.'/lib/css/foundation.min.css', array(), null, 'all' );
    ...
    // now scripts
    wp_enqueue_script( 'foundation', RKV_BASE.'/lib/js/foundation.min.js', array('jquery'), null, true );
    wp_enqueue_script( 'foundation-app', RKV_BASE.'/lib/js/app.js', array('jquery'), null, true );
