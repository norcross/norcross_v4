...
-->        
    ...
    <div class="nav nav-list">
        ...
        <p class="home-button"><a class="btn btn-primary" href="<?php bloginfo('url'); ?>/plugins/">Check Them Out &raquo;</a></p>
        </div>
        ...
        <p class="home-button"><a class="btn btn-primary" href="<?php bloginfo('url'); ?>/tutorials/">Learn Something &raquo;</a></p>
        </div>
        ...
        <p class="home-button"><a class="btn btn-primary" href="<?php bloginfo('url'); ?>/snippets/">View Them &raquo;</a></p>
        </div>
